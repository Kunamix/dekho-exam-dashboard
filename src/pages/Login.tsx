...
const Login = () => {
  ...
  const [errors, setErrors] = useState<{ email?: string; password?: string; phone?: string; general?: string }>({});
  ...
  const validateForm = (): boolean => {
    ...
    if (loginMethod === 'email') {
      ...
      else if (!validatePhone(phoneNumber)) newErrors.phone = 'Enter a valid 10-digit phone number';
    }
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">Welcome back! Access your dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {loginMethod === 'email' ? (
              <>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Mail className={cn("absolute left-3 top-3.5 h-5 w-5", errors.email ? "text-destructive" : "text-muted-foreground")} />
                    <input
                      id="email"
                      type="email"
                      value={email}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Lock className={cn("absolute left-3 top-3.5 h-5 w-5", errors.password ? "text-destructive" : "text-muted-foreground")} />
                    <input
                      id="password"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Phone className={cn("absolute left-3 top-3.5 h-5 w-5", errors.phone ? "text-destructive" : "text-muted-foreground")} />
                  <input
                    id="phone"
                    type="tel"
                    maxLength={10}
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <p className="text-lg text-white/80 mb-8 max-w-md">Empowering students with comprehensive resources</p>
          <div className="flex items-center gap-8">
            <div className="text-center">
              <div className="flex items-center justify-center w-14 h-14 bg-white/10 rounded-xl mb-2"><Users className="h-7 w-7" /></div>
              <p className="text-2xl font-bold">10K+</p>
              <p className="text-sm text-white/70">Students</p>
            </div>
            <div className="w-px h-16 bg-white/20" />
            <div className="text-center">
              <div className="flex items-center justify-center w-14 h-14 bg-white/10 rounded-xl mb-2"><BookOpen className="h-7 w-7" /></div>
